...
@Entity
@Table(name = "pseudonym_chain")
@Immutable
@Getter
@Setter
@ToString
public class PseudonymChainEntity implements Persistable<byte[]> {
   ...
   *
   * <p>Required because we use manually assigned IDs instead of auto-generated ones. Without this
   * implementation, Spring Data would execute a SELECT statement before each INSERT to determine if
   * the entity exists, causing performance overhead.
   */
  @Override
