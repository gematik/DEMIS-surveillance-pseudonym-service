...
class PseudonymController implements PseudonymEndpoint {

  private final PseudonymProcessor pseudonymProcessor;

  @Override
  public PseudonymOutput createPseudonym(final PseudonymInput input) {
    return pseudonymProcessor.createPseudonym(input);
  }
}
